      ...
      <div className="container">
        ...
        >
          ...
          <motion.div className="footer-section links" variants={itemVariants}>
            ...
            <ul>
              <li><a href="#home">{lang === 'id' ? 'Beranda' : lang === 'en' ? 'Home' : 'ホーム'}</a></li>
              <li><a href="#services">{lang === 'id' ? 'Layanan' : lang === 'en' ? 'Services' : 'サービス'}</a></li>
              <li><a href="#pricing">{lang === 'id' ? 'Harga' : lang === 'en' ? 'Pricing' : '料金'}</a></li>
              <li><a href="#faq">FAQ</a></li>
              <li><a href="#terms">{lang === 'id' ? 'Ketentuan' : lang === 'en' ? 'Terms' : '規約'}</a></li>
            </ul>
          </motion.div>
