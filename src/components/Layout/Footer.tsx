  ...
  return (
    <footer className="footer" id="footer">
      <div className="container">
        ...
        >
          ...
          <motion.div className="footer-section brand" variants={itemVariants}>
            <div className="footer-brand">
              <Image src="/logo-64.png" width={44} height={44} alt="" />
              <h3>Nihong Jastip</h3>
            </div>
            <p>
              {lang === 'id'
            ...
            <div className="footer-socials">
              ...
              <a href="https://www.facebook.com/profile.php?id=61556636232972" target="_blank" rel="noreferrer" aria-label="Facebook">
                <Facebook size={20} />
              </a>
              <a href="https://www.tiktok.com/@nihongjastip" target="_blank" rel="noreferrer" aria-label="TikTok">
          ...
          <motion.div className="footer-section links" variants={itemVariants}>
            ...
            <ul>
              ...
              <li><a href="#process" onClick={handleNavClick('process')}>{lang === 'id' ? 'Cara Kerja' : lang === 'en' ? 'How It Works' : 'ご利用の流れ'}</a></li>
              <li><a href="#pricing" onClick={handleNavClick('pricing')}>{lang === 'id' ? 'Cek Tarif' : lang === 'en' ? 'Rates' : '料金'}</a></li>
        ...
        >
          <p>Copyright ©{new Date().getFullYear()} Nihong Jastip. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
